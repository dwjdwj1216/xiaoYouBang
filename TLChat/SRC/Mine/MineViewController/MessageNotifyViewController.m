...
@property (nonatomic, strong)MessageNotifyHelper *messageHelper;
...
- (void)viewDidLoad {
    ...
    self.data = self.messageHelper.messageData;
...
#pragma mark - Getter
- (MessageNotifyHelper *)messageHelper{
    if (!_messageHelper) {
        _messageHelper = [[MessageNotifyHelper alloc]init];
    }
