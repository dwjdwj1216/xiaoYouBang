...
- (void)setUser:(TLUser *)user
{
    ...
    [self.avatarView setImage:[UIImage imageNamed:user.avatarPath] imageHL:[UIImage imageNamed:user.avatarPath]];
...
- (UIButton *)backgroundWall
{
    if (_backgroundWall == nil) {
        ...
        [_backgroundWall setBackgroundColor:[UIColor colorWithWhite:0.5 alpha:0.3]];
    }
