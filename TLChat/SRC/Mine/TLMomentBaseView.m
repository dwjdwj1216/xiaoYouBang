...
{
    _moment = moment;
    [self.avatarView sd_setImageWithURL:TLURL(moment.user.avatarURL) forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"avatar"]];
    [self.usernameView setTitle:@"insomnium" forState:UIControlStateNormal];
...
- (UIButton *)usernameView
{
    if (_usernameView == nil) {
        ...
        [_usernameView setTitleColor:[UIColor colorWithRed:74.0/255.0 green:99.0/255.0 blue:141.0/255.0 alpha:1] forState:UIControlStateNormal];
